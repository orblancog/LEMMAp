...
int DrawPhaseSpace (const char * k) {//k is the flag name 
  ...
  trackfl->Append(k);
  TH2 * trackxpx = new TH2F("H. Phase Space","H Phase Space",400,-40,40,400,-40,40);
  TH2 * trackypy = new TH2F("V. Phase Space","V Phase Space",400,-40,40,400,-40,40);
  ...
  tracksd->GetXaxis()->SetTitle("t [ms]");
